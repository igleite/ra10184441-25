...
public class GetFeatureFlagByIdQueryHandler : IQueryHandler<GetFeatureFlagByIdQuery, FeatureFlagDto>
{
    private readonly IUnitOfWork _unitOfWork;

    public GetFeatureFlagByIdQueryHandler(IUnitOfWork unitOfWork)
    {
